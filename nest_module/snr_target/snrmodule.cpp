...
const std::string
snrmodule::name() const
{
  return std::string("snrmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
snrmodule::init( SLIInterpreter* i )
{
  
    nest::kernel().model_manager.register_node_model<snr>("snr");
