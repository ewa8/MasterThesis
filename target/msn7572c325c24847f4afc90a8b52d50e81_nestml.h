...
/**
 *  msn7572c325c24847f4afc90a8b52d50e81_nestml.h
 *
 ...
 *
 *  Generated from NESTML at time: 2022-11-16 08:28:55.378554
**/
#ifndef MSN7572C325C24847F4AFC90A8B52D50E81_NESTML
#define MSN7572C325C24847F4AFC90A8B52D50E81_NESTML
...
namespace nest
{
namespace msn7572c325c24847f4afc90a8b52d50e81_nestml_names
{
    const Name _V_m( "V_m" );
    const Name _U_m( "U_m" );
    const Name _I( "I" );
...
**/
extern "C" inline int msn7572c325c24847f4afc90a8b52d50e81_nestml_dynamics( double, const double y[], double f[], void* pnode );
...
/* BeginDocumentation
  Name: msn7572c325c24847f4afc90a8b52d50e81_nestml.
...
*/
class msn7572c325c24847f4afc90a8b52d50e81_nestml : public nest::StructuralPlasticityNode
{
public:
  /**
   * The constructor is only used to create the model prototype in the model manager.
  **/
  msn7572c325c24847f4afc90a8b52d50e81_nestml();
  ...
  **/
  msn7572c325c24847f4afc90a8b52d50e81_nestml(const msn7572c325c24847f4afc90a8b52d50e81_nestml &);

  /**
   * Destructor.
  **/
  ~msn7572c325c24847f4afc90a8b52d50e81_nestml() override;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<msn7572c325c24847f4afc90a8b52d50e81_nestml>;
  friend class nest::UniversalDataLogger<msn7572c325c24847f4afc90a8b52d50e81_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(msn7572c325c24847f4afc90a8b52d50e81_nestml &);
    Buffers_(const Buffers_ &, msn7572c325c24847f4afc90a8b52d50e81_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<msn7572c325c24847f4afc90a8b52d50e81_nestml> logger_;
...
double I_stim_grid_sum_;
  ...
  static nest::RecordablesMap<msn7572c325c24847f4afc90a8b52d50e81_nestml> recordablesMap_;
  friend int msn7572c325c24847f4afc90a8b52d50e81_nestml_dynamics( double, const double y[], double f[], void* pnode );


}; /* neuron msn7572c325c24847f4afc90a8b52d50e81_nestml */

inline nest::port msn7572c325c24847f4afc90a8b52d50e81_nestml::send_test_event(nest::Node& target, nest::rport receptor_type, nest::synindex, bool)
{
...
inline nest::port msn7572c325c24847f4afc90a8b52d50e81_nestml::handles_test_event(nest::SpikeEvent&, nest::port receptor_type)
{
...
inline nest::port msn7572c325c24847f4afc90a8b52d50e81_nestml::handles_test_event(nest::CurrentEvent&, nest::port receptor_type)
{
  // You should usually not change the code in this function.
...
inline nest::port msn7572c325c24847f4afc90a8b52d50e81_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest::port receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void msn7572c325c24847f4afc90a8b52d50e81_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_a, get_a());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_b, get_b());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_c, get_c());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_d, get_d());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_I_e, get_I_e());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_th, get_V_th());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_min, get_V_min());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_Kplus, get_Kplus());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_vp, get_vp());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_T, get_V_T());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_C_m, get_C_m());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_c_1, get_c_1());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_c_2, get_c_2());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_y1, get_y1());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_y2, get_y2());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_alpha_1, get_alpha_1());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_alpha_2, get_alpha_2());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_alpha, get_alpha());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_tau_decay_AMPA, get_tau_decay_AMPA());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_tau_decay_GABA_A, get_tau_decay_GABA_A());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_tau_decay_NMDA, get_tau_decay_NMDA());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_E_rev_AMPA, get_E_rev_AMPA());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_E_rev_GABA_A, get_E_rev_GABA_A());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_E_rev_NMDA, get_E_rev_NMDA());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_m, get_V_m());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_U_m, get_U_m());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_I, get_I());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_dop, get_dop());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_ampa__X__spikes_ampa, get_kernel_ampa__X__spikes_ampa());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_nmda__X__spikes_nmda, get_kernel_nmda__X__spikes_nmda());
  def<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_gaba__X__spikes_gaba, get_kernel_gaba__X__spikes_gaba());
...
inline void msn7572c325c24847f4afc90a8b52d50e81_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_a = get_a();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_a, tmp_a);
  double tmp_b = get_b();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_b, tmp_b);
  double tmp_c = get_c();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_c, tmp_c);
  double tmp_d = get_d();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_d, tmp_d);
  double tmp_I_e = get_I_e();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_I_e, tmp_I_e);
  double tmp_V_th = get_V_th();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_th, tmp_V_th);
  double tmp_V_min = get_V_min();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_min, tmp_V_min);
  double tmp_Kplus = get_Kplus();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_Kplus, tmp_Kplus);
  double tmp_vp = get_vp();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_vp, tmp_vp);
  double tmp_V_T = get_V_T();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_T, tmp_V_T);
  double tmp_C_m = get_C_m();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_C_m, tmp_C_m);
  double tmp_c_1 = get_c_1();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_c_1, tmp_c_1);
  double tmp_c_2 = get_c_2();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_c_2, tmp_c_2);
  double tmp_y1 = get_y1();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_y1, tmp_y1);
  double tmp_y2 = get_y2();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_y2, tmp_y2);
  double tmp_alpha_1 = get_alpha_1();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_alpha_1, tmp_alpha_1);
  double tmp_alpha_2 = get_alpha_2();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_alpha_2, tmp_alpha_2);
  double tmp_alpha = get_alpha();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_alpha, tmp_alpha);
  double tmp_tau_decay_AMPA = get_tau_decay_AMPA();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_tau_decay_AMPA, tmp_tau_decay_AMPA);
  double tmp_tau_decay_GABA_A = get_tau_decay_GABA_A();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_tau_decay_GABA_A, tmp_tau_decay_GABA_A);
  double tmp_tau_decay_NMDA = get_tau_decay_NMDA();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_tau_decay_NMDA, tmp_tau_decay_NMDA);
  double tmp_E_rev_AMPA = get_E_rev_AMPA();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_E_rev_AMPA, tmp_E_rev_AMPA);
  double tmp_E_rev_GABA_A = get_E_rev_GABA_A();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_E_rev_GABA_A, tmp_E_rev_GABA_A);
  double tmp_E_rev_NMDA = get_E_rev_NMDA();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_E_rev_NMDA, tmp_E_rev_NMDA);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_m, tmp_V_m);
  double tmp_U_m = get_U_m();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_U_m, tmp_U_m);
  double tmp_I = get_I();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_I, tmp_I);
  double tmp_dop = get_dop();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_dop, tmp_dop);
  double tmp_kernel_ampa__X__spikes_ampa = get_kernel_ampa__X__spikes_ampa();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_ampa__X__spikes_ampa, tmp_kernel_ampa__X__spikes_ampa);
  double tmp_kernel_nmda__X__spikes_nmda = get_kernel_nmda__X__spikes_nmda();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_nmda__X__spikes_nmda, tmp_kernel_nmda__X__spikes_nmda);
  double tmp_kernel_gaba__X__spikes_gaba = get_kernel_gaba__X__spikes_gaba();
  updateValue<double>(__d, nest::msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_gaba__X__spikes_gaba, tmp_kernel_gaba__X__spikes_gaba);
...
#endif /* #ifndef MSN7572C325C24847F4AFC90A8B52D50E81_NESTML */
