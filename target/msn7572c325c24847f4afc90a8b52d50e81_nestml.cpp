// #define DEBUG 1
/*
 *  msn7572c325c24847f4afc90a8b52d50e81_nestml.cpp
 *
...
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<msn7572c325c24847f4afc90a8b52d50e81_nestml> msn7572c325c24847f4afc90a8b52d50e81_nestml::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<msn7572c325c24847f4afc90a8b52d50e81_nestml>::create()
  {
    // add state variables to recordables map
   insert_(msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_V_m, &msn7572c325c24847f4afc90a8b52d50e81_nestml::get_V_m);
   insert_(msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_U_m, &msn7572c325c24847f4afc90a8b52d50e81_nestml::get_U_m);
   insert_(msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_I, &msn7572c325c24847f4afc90a8b52d50e81_nestml::get_I);
   insert_(msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_dop, &msn7572c325c24847f4afc90a8b52d50e81_nestml::get_dop);
   insert_(msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_ampa__X__spikes_ampa, &msn7572c325c24847f4afc90a8b52d50e81_nestml::get_kernel_ampa__X__spikes_ampa);
   insert_(msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_nmda__X__spikes_nmda, &msn7572c325c24847f4afc90a8b52d50e81_nestml::get_kernel_nmda__X__spikes_nmda);
   insert_(msn7572c325c24847f4afc90a8b52d50e81_nestml_names::_kernel_gaba__X__spikes_gaba, &msn7572c325c24847f4afc90a8b52d50e81_nestml::get_kernel_gaba__X__spikes_gaba);
...
//   is a part of msn7572c325c24847f4afc90a8b52d50e81_nestml's constructor.
// ---------------------------------------------------------------------------

msn7572c325c24847f4afc90a8b52d50e81_nestml::Parameters_::Parameters_()
{
}

msn7572c325c24847f4afc90a8b52d50e81_nestml::State_::State_()
{
}
...
msn7572c325c24847f4afc90a8b52d50e81_nestml::Buffers_::Buffers_(msn7572c325c24847f4afc90a8b52d50e81_nestml &n):
  logger_(n)
...
msn7572c325c24847f4afc90a8b52d50e81_nestml::Buffers_::Buffers_(const Buffers_ &, msn7572c325c24847f4afc90a8b52d50e81_nestml &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( SUP_SPIKE_RECEPTOR - 1 ) )
  , __s( nullptr ), __c( nullptr ), __e( nullptr )
{
...
msn7572c325c24847f4afc90a8b52d50e81_nestml::msn7572c325c24847f4afc90a8b52d50e81_nestml():StructuralPlasticityNode(), P_(), S_(), B_(*this)
{
...
msn7572c325c24847f4afc90a8b52d50e81_nestml::msn7572c325c24847f4afc90a8b52d50e81_nestml(const msn7572c325c24847f4afc90a8b52d50e81_nestml& __n):
...
msn7572c325c24847f4afc90a8b52d50e81_nestml::~msn7572c325c24847f4afc90a8b52d50e81_nestml()
{
...
void msn7572c325c24847f4afc90a8b52d50e81_nestml::init_buffers_()
{
...
get_I_stim().clear(); // includes resize
  ...
  B_.__sys.function = msn7572c325c24847f4afc90a8b52d50e81_nestml_dynamics;
...
void msn7572c325c24847f4afc90a8b52d50e81_nestml::recompute_internal_variables(bool exclude_timestep) {
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void msn7572c325c24847f4afc90a8b52d50e81_nestml::calibrate() {
  B_.logger_.init();
...
extern "C" inline int msn7572c325c24847f4afc90a8b52d50e81_nestml_dynamics(double, const double ode_state[], double f[], void* pnode)
{
  typedef msn7572c325c24847f4afc90a8b52d50e81_nestml::State_ State_;
  // get access to node so we can almost work as in a member function
  assert( pnode );
  const msn7572c325c24847f4afc90a8b52d50e81_nestml& node = *( reinterpret_cast< msn7572c325c24847f4afc90a8b52d50e81_nestml* >( pnode ) );
...
void msn7572c325c24847f4afc90a8b52d50e81_nestml::update(nest::Time const & origin,const long from, const long to)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void msn7572c325c24847f4afc90a8b52d50e81_nestml::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}

void msn7572c325c24847f4afc90a8b52d50e81_nestml::handle(nest::SpikeEvent &e)
{
...
void msn7572c325c24847f4afc90a8b52d50e81_nestml::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
